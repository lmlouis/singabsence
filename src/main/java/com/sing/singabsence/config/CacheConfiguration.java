...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.sing.singabsence.domain.Leave.class.getName() + ".senttos");
            createCache(cm, com.sing.singabsence.domain.Leave.class.getName() + ".ownworkflows");
            ...
            createCache(cm, com.sing.singabsence.domain.Message.class.getName() + ".oneleaves");
            createCache(cm, com.sing.singabsence.domain.Message.class.getName() + ".ownworkflows");
            ...
            createCache(cm, com.sing.singabsence.domain.Event.class.getName() + ".oneleaves");
