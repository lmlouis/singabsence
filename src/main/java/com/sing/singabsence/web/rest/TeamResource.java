...
import com.sing.singabsence.repository.TeamRepository;
import com.sing.singabsence.service.TeamService;
...
/**
 * REST controller for managing {@link com.sing.singabsence.domain.Team}.
 */
@RestController
...
public class TeamResource {
     ...
     */
    @GetMapping("")
    public List<TeamDTO> getAllTeams(@RequestParam(required = false, defaultValue = "true") boolean eagerload) {
