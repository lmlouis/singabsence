...
/**
 * REST controller for managing {@link com.sing.singabsence.domain.Message}.
 */
@RestController
...
public class MessageResource {
     ...
     */
    @GetMapping("")
    public List<MessageDTO> getAllMessages(@RequestParam(required = false, defaultValue = "true") boolean eagerload) {
