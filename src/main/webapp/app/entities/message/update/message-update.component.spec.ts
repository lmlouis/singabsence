...
describe('Message Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Employee query and add missing value', () => {
      ...
      const tos: IEmployee[] = [{ id: 14167 }];
      message.tos = tos;

      const employeeCollection: IEmployee[] = [{ id: 3882 }];
    ...
    it('Should call from query and add missing value', () => {
      const message: IMessage = { id: 456 };
      const from: IEmployee = { id: 24646 };
      message.from = from;

      const fromCollection: IEmployee[] = [{ id: 7738 }];
    ...
    it('Should call Attachment query and add missing value', () => {
      const message: IMessage = { id: 456 };
      const attachements: IAttachment[] = [{ id: 5481 }];
    ...
    it('Should update editForm', () => {
      const message: IMessage = { id: 456 };
      const from: IEmployee = { id: 28661 };
      message.from = from;
      const to: IEmployee = { id: 2991 };
      message.tos = [to];
      const attachements: IAttachment = { id: 7686 };
      message.attachements = [attachements];
