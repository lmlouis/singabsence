...
class MessageResourceIT {
    ...
    private static final Boolean DEFAULT_ISREAD = false;
    private static final Boolean UPDATED_ISREAD = true;
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().purpose(DEFAULT_PURPOSE).content(DEFAULT_CONTENT).sentat(DEFAULT_SENTAT).isread(DEFAULT_ISREAD);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().purpose(UPDATED_PURPOSE).content(UPDATED_CONTENT).sentat(UPDATED_SENTAT).isread(UPDATED_ISREAD);
        return message;
    }
    ...
    void createMessage() throws Exception {
        ...
        assertThat(testMessage.getPurpose()).isEqualTo(DEFAULT_PURPOSE);
        assertThat(testMessage.getContent()).isEqualTo(DEFAULT_CONTENT);
        assertThat(testMessage.getSentat()).isEqualTo(DEFAULT_SENTAT);
        assertThat(testMessage.getIsread()).isEqualTo(DEFAULT_ISREAD);
    }
    ...
    void getAllMessages() throws Exception {
        ...
        restMessageMockMvc
            ...
            .andExpect(jsonPath("$.[*].isread").value(hasItem(DEFAULT_ISREAD.booleanValue())));
    }
    ...
    void getMessage() throws Exception {
        ...
        restMessageMockMvc
            ...
            .andExpect(jsonPath("$.isread").value(DEFAULT_ISREAD.booleanValue()));
    }
    ...
    void putExistingMessage() throws Exception {
        ...
        updatedMessage.purpose(UPDATED_PURPOSE).content(UPDATED_CONTENT).sentat(UPDATED_SENTAT).isread(UPDATED_ISREAD);
        ...
        Message testMessage = messageList.get(messageList.size() - 1);
        assertThat(testMessage.getPurpose()).isEqualTo(UPDATED_PURPOSE);
        assertThat(testMessage.getContent()).isEqualTo(UPDATED_CONTENT);
        assertThat(testMessage.getSentat()).isEqualTo(UPDATED_SENTAT);
        assertThat(testMessage.getIsread()).isEqualTo(UPDATED_ISREAD);
    }
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.purpose(UPDATED_PURPOSE).content(UPDATED_CONTENT).sentat(UPDATED_SENTAT).isread(UPDATED_ISREAD);
