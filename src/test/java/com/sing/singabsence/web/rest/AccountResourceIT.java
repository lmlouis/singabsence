...
import com.sing.singabsence.config.Constants;
import com.sing.singabsence.domain.User;
import com.sing.singabsence.repository.AuthorityRepository;
import com.sing.singabsence.repository.UserRepository;
import com.sing.singabsence.security.AuthoritiesConstants;
import com.sing.singabsence.service.UserService;
import com.sing.singabsence.service.dto.AdminUserDTO;
import com.sing.singabsence.service.dto.PasswordChangeDTO;
import com.sing.singabsence.web.rest.vm.KeyAndPasswordVM;
import com.sing.singabsence.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        authorities.add(AuthoritiesConstants.ADMINISTRATOR);
        ...
        restAccountMockMvc
            ...
            .andExpect(jsonPath("$.authorities").value(AuthoritiesConstants.ADMINISTRATOR));
    }
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.ADMINISTRATOR));
        ...
        assertThat(userDup.orElseThrow().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.EMPLOYEE).orElseThrow());
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.ADMINISTRATOR));
