...
class AttachmentResourceIT {
    ...
    private static final TypeOfAttachment DEFAULT_CATEGORY = TypeOfAttachment.IMAGE;
    private static final TypeOfAttachment UPDATED_CATEGORY = TypeOfAttachment.DOCUMENT;
    ...
    void createAttachment() throws Exception {
        ...
        assertThat(testAttachment.getCategory()).isEqualTo(DEFAULT_CATEGORY);
        assertThat(testAttachment.getPicture()).isEqualTo(DEFAULT_PICTURE);
        assertThat(testAttachment.getPictureContentType()).isEqualTo(DEFAULT_PICTURE_CONTENT_TYPE);
        assertThat(testAttachment.getDocument()).isEqualTo(DEFAULT_DOCUMENT);
        assertThat(testAttachment.getDocumentContentType()).isEqualTo(DEFAULT_DOCUMENT_CONTENT_TYPE);
    }
    ...
    void putExistingAttachment() throws Exception {
        ...
        assertThat(testAttachment.getCategory()).isEqualTo(UPDATED_CATEGORY);
        assertThat(testAttachment.getPicture()).isEqualTo(UPDATED_PICTURE);
        assertThat(testAttachment.getPictureContentType()).isEqualTo(UPDATED_PICTURE_CONTENT_TYPE);
        assertThat(testAttachment.getDocument()).isEqualTo(UPDATED_DOCUMENT);
        assertThat(testAttachment.getDocumentContentType()).isEqualTo(UPDATED_DOCUMENT_CONTENT_TYPE);
    }
