...
class EventResourceIT {
    ...
    public static Event createEntity(EntityManager em) {
        Event event = new Event().title(DEFAULT_TITLE).start(DEFAULT_START).end(DEFAULT_END).link(DEFAULT_LINK);
        return event;
    }
    ...
    public static Event createUpdatedEntity(EntityManager em) {
        Event event = new Event().title(UPDATED_TITLE).start(UPDATED_START).end(UPDATED_END).link(UPDATED_LINK);
        return event;
    }
    ...
    void putExistingEvent() throws Exception {
        ...
        updatedEvent.title(UPDATED_TITLE).start(UPDATED_START).end(UPDATED_END).link(UPDATED_LINK);
    ...
    void partialUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.title(UPDATED_TITLE).start(UPDATED_START).end(UPDATED_END).link(UPDATED_LINK);
