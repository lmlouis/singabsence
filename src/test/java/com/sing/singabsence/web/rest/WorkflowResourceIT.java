...
class WorkflowResourceIT {
    ...
    public static Workflow createEntity(EntityManager em) {
        Workflow workflow = new Workflow().status(DEFAULT_STATUS).description(DEFAULT_DESCRIPTION);
        return workflow;
    }
    ...
    public static Workflow createUpdatedEntity(EntityManager em) {
        Workflow workflow = new Workflow().status(UPDATED_STATUS).description(UPDATED_DESCRIPTION);
        return workflow;
    }
    ...
    void putExistingWorkflow() throws Exception {
        ...
        updatedWorkflow.status(UPDATED_STATUS).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateWorkflowWithPatch() throws Exception {
        ...
        partialUpdatedWorkflow.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateWorkflowWithPatch() throws Exception {
        ...
        partialUpdatedWorkflow.status(UPDATED_STATUS).description(UPDATED_DESCRIPTION);
