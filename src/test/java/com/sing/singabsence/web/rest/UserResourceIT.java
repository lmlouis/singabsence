...
import com.sing.singabsence.domain.Authority;
...
import com.sing.singabsence.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    void createUser() throws Exception {
        ...
        user.setImageUrl(DEFAULT_IMAGEURL);
        user.setLangKey(DEFAULT_LANGKEY);
        user.setAuthorities(Collections.singleton(AuthoritiesConstants.EMPLOYEE));
    ...
    void testUserDTOtoUser() {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.EMPLOYEE));
        ...
        assertThat(user.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.EMPLOYEE);
    }
    ...
    void testUserToUserDTO() {
        ...
        assertThat(userDTO.getAuthorities()).containsExactly(AuthoritiesConstants.EMPLOYEE);
    ...
    void testAuthorityEquals() {
        ...
        authorityB.setName(AuthoritiesConstants.ADMINISTRATOR);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityA.setName(AuthoritiesConstants.EMPLOYEE);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityB.setName(AuthoritiesConstants.EMPLOYEE);
