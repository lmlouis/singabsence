...
class EmployeeTest {
    ...
    void requestTest() throws Exception {
        ...
        employee.setRequest(leaveBack);
        assertThat(employee.getRequest()).isEqualTo(leaveBack);
        assertThat(leaveBack.getOwner()).isEqualTo(employee);

        employee.request(null);
        assertThat(employee.getRequest()).isNull();
        assertThat(leaveBack.getOwner()).isNull();
    }
    ...
    void requestsTest() throws Exception {
        ...
        employee.addRequests(leaveBack);
        assertThat(employee.getRequests()).containsOnly(leaveBack);
        assertThat(leaveBack.getSenttos()).containsOnly(employee);

        employee.removeRequests(leaveBack);
        assertThat(employee.getRequests()).doesNotContain(leaveBack);
        assertThat(leaveBack.getSenttos()).doesNotContain(employee);
