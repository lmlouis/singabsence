...
class WorkflowTest {
    ...
    void validationTest() throws Exception {
        ...
        workflow.setValidation(messageBack);
        assertThat(workflow.getValidation()).isEqualTo(messageBack);

        workflow.validation(null);
        assertThat(workflow.getValidation()).isNull();
    }
    ...
    void requestTest() throws Exception {
        ...
        workflow.setRequest(leaveBack);
        assertThat(workflow.getRequest()).isEqualTo(leaveBack);

        workflow.request(null);
        assertThat(workflow.getRequest()).isNull();
    }
