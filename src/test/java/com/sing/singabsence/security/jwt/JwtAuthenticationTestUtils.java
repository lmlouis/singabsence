...
import static com.sing.singabsence.security.SecurityUtils.AUTHORITIES_KEY;
import static com.sing.singabsence.security.SecurityUtils.JWT_ALGORITHM;
...
public class JwtAuthenticationTestUtils {
    ...
    public static String createValidTokenForUser(String jwtKey, String user) {
        ...
        JwtClaimsSet claims = JwtClaimsSet
            ...
            .subject(user)
            .claims(customClain -> customClain.put(AUTHORITIES_KEY, Collections.singletonList("ROLE_ADMINISTRATOR")))
            .build();
